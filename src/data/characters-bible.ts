...
export const charactersBible: CharacterDetail[] = [
  {
    ...
    keyScenes: [
      ...
      "Hallway (BGCi) — between Fiona and Niamh; watches wit become handle; double’s kindness closes the corridor.",
      "Anteroom (BGCi) — volunteers for a pair; chalk hierarchy; visibility as unwanted currency.",
      "Landing (BGCi) — Niamh names withholding as shape; abstention read as fuel; ringed, no door.",
      "Armory anteroom — ‘Then stop teaching.’; Whiff after collapse—Ciarán flares superstitiously; metal taste; no stronger saviour.",
      "Library nook — refuses to be Niamh’s receipt; watches last ‘objective’ ally fold; can’t outsource witness.",
      "Small salon — Erin begs language that only sounds true; Aoife won’t perform it; double gives the comfort; Aoife watches, can’t look away.",
      "Dark Night — hallways/stairs: routed by doubles, kettle denied, Niamh double receipts line; Ciarán’s absence; “If I don’t testify for myself, the house will.”; Mrs. Keane gallery mouth.",
    ...
    dialogueTone:
      "Understated, often incomplete; sparse claims that land hard (“I’m tired”; “It wasn’t asking”; “We’re not outside—we’re in its pocket”; Dark Night: “If I don’t testify for myself, the house will.”). McKee-shaped: subtext first—silence, deflection, and small concrete nouns carry theme; avoid therapy-speak or thesis lines in her mouth.",
    keyLine: "If I don’t testify for myself, the house will.",
    visualPresence:
  ...
  },
  {
    ...
    keyScenes: [
      ...
      "Corridor / anteroom (BGCi) — pairs, logs, chalk; “not court—older”; procedure as testimony; refuses motions.",
  ...
  },
  {
    ...
    judgmentPattern:
      "Steps into his double on a rest offer (“You can sleep. A real one.”)—surrender mistaken for relief; not the line “I’m tired,” which is **Aoife’s** in the current script.",
    relationshipToProtagonist:
      "The ally who reads her quiet on the landing (*just not neutral*, *delay*); later names **Quiet isn’t neutral** outright on the back stair; his erasure removes her last co-defendant—she can’t wait for someone braver to stay.",
    keyScenes: [
      "Dining room — names Aoife out of invisibility without stealing her voice.",
      "Stair landing — *just not neutral* / breathing; car *off*, wheel; *not yet* naming; afraid as *delay*; reflection syncs—debt as safety.",
      "Upper landing (BGCi) — mediates Niamh/Aoife; ‘first honest thing’ on *I don’t know yet*; grateful for limit named aloud.",
      "Fields escape — grand/mud/bothy *counted*; *bait when it waves*; *mercy on the lie*; morning: cup, fogged watch, almost *Quiet isn’t…*.",
      "Back staircase (BGCi) — one true sentence; she defers (*walls taking minutes* / *not ours*); *Alright* costs him before All Is Lost.",
      "All Is Lost — near-refusal (*find another witness*); double: *no one left to be tired for you now*; sleep offer; steps through; co-defendant gone.",
    ],
    dialogueTone:
      "Warm, direct emotion; fatigue under the kindness. Hiberno tags (yeah, grand, names). McKee-shaped: contact over principle—comfort and question before aphorism; if he moralises, keep it short and spoken to her, not the room.",
    visualPresence: "Open posture; seeks contact; tired eyes.",
    systemTruth: { responseToTruth: "Accept", outcome: "Erased" },
    keyLine: "Quiet isn’t neutral. It’s a choice.",
  },
  {
    id: "fiona",
    slug: "fiona-walsh",
    ...
    keyScenes: [
      ...
      "Hallway (BGCi) — long corridor beat; wit as sandbags; double out-kindnesses her; ‘I’ll take the next laugh’; Niamh steps in.",
      "Pond cluster — knuckle to water: warm skin, cold air; the lie bothers her.",
      "Doubles corridor — embrace that won’t let go.",
      "Small salon — witness; reflex joke; her double lands the punchline—synced laughter—then she looks away while Aoife cannot—difference will matter.",
    ],
    dialogueTone:
      "Wit, interruption, rhetorical deflection; comic specificity (Irish radio, workplace rotas) over generic US pop-reference.",
  ...
  },
  {
    ...
    keyScenes: [
      ...
      "Perimeter / doors — won’t yield to force or procedure; Aoife’s postern proves the loop.",
      "Debate — turns from her; leadership without intimacy.",
      "Corridor / anteroom — containment theatre; rotation, quarantine language; Mrs. Keane strips trial frame.",
      "Armory anteroom — solicitor-to-solicitor fails; shove absorbed; collapse; Whiff: double—body stops negotiating, clock won’t tick, exit-counting foreshadow; Aoife ‘Get up’ unheard.",
      "Ensemble — control tested as rules harden; Sean (double) as immovable verdict.",
    ],
    dialogueTone:
      "Imperatives, plans, moral leverage; rare admission of doubt. McKee-shaped: procedure as armour—won’t trade quips with Fiona at horror-movie pitch; clamps to evidence, order, next step.",
  ...
  },
  {
    ...
    keyScenes: [
      ...
      "Procession corridor — **Padraig’s double**: “You’re going the right way”; courtesy as trap.",
      "Dining room — the wrong face at the table.",
    ],
    dialogueTone:
      "Short, defensive, swallowed sentences. Not the ensemble’s quip machine—his jokes curdle; leave wisecrack density to Fiona.",
  ...
  },
  {
    ...
    keyScenes: [
      ...
      "Landing (BGCi) — pattern lecture; naming vs sample; ‘I don’t know yet’ strips expert armour.",
      "Library nook — double punctures observer shield; freeze-as-data; ‘mercy’ as slower moral; map never neutral.",
      ...
      "Hallway — ‘Fiona. Step back.’; won’t look away; witness as sentence.",
    ],
    dialogueTone:
      "Sparse; when she speaks, it lands—precise, pattern-forward, not riff-heavy; McKee-shaped: datum over metaphor when theory is live.",
  ...
  },
  {
    ...
    keyScenes: [
      ...
      "Small salon — demands sounding-true relief; double gives *alright*; body surrenders; counterfeit contact mistaken for rescue.",
  ...
  },
  {
    ...
    portraitVideoSrc: "/characters/Aoife%20Kelleher%20(Double).mp4",
    ...
    keyScenes: [
      "Silent seeds (Act I–II): car rearview; debate wine; stair-landing dark pane; Act One pond lip; pond procedure beat; B-story guest-room glass; pre-midpoint pond margin—all action-only, the “finished” face before she speaks.",
      "Gallery — Dark Night setpiece: ledger-glass, double *decides into* room; ‘finish it’ / ‘no difference’; first clean No; reflection lags; walk without pursuit.",
      "Great door — offer reprise: gallery callback, in-room presence, truth of stillness; pound vs void.",
      "Void threshold — “You already chose.” as receipt; she names owning it aloud; bookend to car-door match cut.",
    ],
